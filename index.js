	...
	cnf.on('chat-update', async (mek) => {
      ...
      const wit = moment.tz('Asia/Jayapura').format('HH:mm:ss')
		...
		const arg = chats.slice(command.length + 2, chats.length)
			...
			const ownerNumber = [`593989901361@s.whatsapp.net`] 
...
const sosGay = checkATMuser(sender)   
                                     lzain = `*╭═✦͜͡ৡৢ┅╡The Queen ╞┅ৡৢ͜͡✦═╮*
*║┊: * ⃟ ⃟  ━ೋ๑——๑ೋ━* ⃟ ⃟ *      
*║◄🔥┢┅ீ͜ৡৢ͜͡✦━◇━ீ͜ৡৢ͜͡✦┅┧🔥►*
*║┊:*      ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈  
*║┊:𝑪𝒓𝒆𝒂𝒅𝒐𝒓 : Queen*
*║┊:𝑵𝒖𝒎𝒆𝒓𝒐 : wa.me/593989901361*
*║┊:YT : The Queen*
*║┊:*      ┈ ┈ ┈ ┈ ┈  ┈ ┈ ┈ 
*║◄🔥┢┅ீ͜ৡৢ͜͡✦━◇━ீ͜ৡৢ͜͡✦┅┧🔥►*
*║┊: * ⃟ ⃟  ━ೋ๑——๑ೋ━* ⃟ ⃟ *      
...
if (!isRegistered) return reply(ind.noregis())			  
            ...
            cnf.sendMessage(from,media,image,{quoted:mek,caption:'The Queen'})
            }
            )
            .catch((error) => {
            console.log(error); 
...
if (!isRegistered) return reply(ind.noregis())			  
                if (!mek.key.fromMe) return reply('*𝐬𝐨𝐥𝐨 𝐪𝐮𝐢𝐞𝐧 𝐝𝐞𝐬𝐚𝐫𝐫𝐨𝐥𝐥𝐨 𝐞𝐥 𝐛𝐨𝐭 𝐩𝐮𝐞𝐝𝐞 𝐮𝐬𝐚𝐫 𝐞𝐬𝐭𝐞 𝐜𝐨𝐦𝐚𝐧𝐝𝐨 𝐚𝐦𝐢𝐤𝐨 𝐮𝐧𝐮*')
	        await cnf.sendMessage(from, `Bye...\n_The Queen apagandose..._`, text,{quoted : freply})
		await sleep(3000)
                cnf.close()
		break
...
if (!isRegistered) return reply(ind.noregis())			  
				if (mek.message.extendedTextMessage != undefined){
					...
					cnf.sendMessage(from, thumb, MessageType.image, {quoted: mek, caption: `The Queen `})}
				break
...
if (!isRegistered) return reply(ind.noregis())			  	
				...
				buffer = fs.readFileSync(ran)
				cnf.sendMessage(from, buffer, image, {quoted: mek, caption: 'The Queen})
				fs.unlinkSync(ran)
			    })
				await limitAdd(sender) 
				break
